...
o username skal være mindst 3 tegn

o email skal indeholde @

o password skal være mindst 6 tegn

· StrictValidationStrategy

o username mindst 6 tegn og må ikke indeholde mellemrum

o email skal matche en simpel regex (fx noget der ligner en mail)

o password mindst 10 tegn og skal indeholde både tal og bogstav
...
Lav en custom exception fx:

· ValidationException extends RuntimeException

Den skal bruges af strategierne.
